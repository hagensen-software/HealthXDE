...
public class AdministrativeGenderValueSetR4 : ValueSet<AdministrativeGenderCoding>
{
    public static readonly CodingVersion hl7AdministrativeGenderVersion = new CodingVersion("4.0.1");
    ...
    public AdministrativeGenderValueSetR4()
        : base(true) { }
